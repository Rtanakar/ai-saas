    ...
    <div className="flex flex-col gap-4 items-center max-w-7xl mx-auto">
      ...
      {uploadInProgress && (
        <div className="mt-32 flex flex-col justify-center items-center gap-5">
          <div
            className={`radial-progress bg-orange-300 text-white border-orange-600 bottom-4 ${
              progress === 100 && "hidden"
            }`}
            role="progressbar"
            style={{
      ...
      {!uploadInProgress && (
        <div
          {...getRootProps()}
          className={`p-10 border-orange-600 text-orange-600 border-2 border-dashed mt-10 w-[90%] rounded-lg h-96 flex items-center text-center justify-center ${
